...
const { validateUserSchema, registerUser, validateOtpSchema, userOtp, validateUserLogin, userLogin, validateForgetPassword, forgetPassword, validateVerifyPassword, verifyPassword, validateChangePassword, changePassword, uploadProfile, validateUploadProfile, upload } = require('../controller/userController.js');
